...
class DefensesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create defense" do
    assert_difference('Defense.count') do
      post defenses_url, params: { defense: { description: @defense.description, name: @defense.name, situation: @defense.situation, style: @defense.style } }
    end
  ...
  test "should update defense" do
    patch defense_url(@defense), params: { defense: { description: @defense.description, name: @defense.name, situation: @defense.situation, style: @defense.style } }
